...
const PlacedStudentsTable = lazy(() => import("./components/TPO/PlacedStudentsTable.jsx"));
        ...
        <Suspense fallback={<LoadingComponent />}>
          <Routes>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['tpo_admin']} /></UserProvider>}>
              ...
              {/* placed students */}
              <Route element={<Layout header="Placed Students" />}>
                <Route path="/tpo/placed-students" element={<PlacedStudentsTable />} />
              </Route>
